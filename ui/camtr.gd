...
func _process(delta: float) -> void:
			...
			self.global_rotation.x=lerp_angle(self.global_rotation.x,targetcam[curt].global_rotation.x,5*delta)
			self.global_rotation.y=lerp_angle(self.global_rotation.y,targetcam[curt].global_rotation.y,5*delta)
			self.global_rotation.z=lerp_angle(self.global_rotation.z,targetcam[curt].global_rotation.z,5*delta)
			#self.global_rotation=targetcam[curt].global_rotation
